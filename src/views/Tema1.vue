...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    p.mb-5 A continuación, se verá un poco más de las leyes que protegen el derecho a los datos personales, en su orden cronológico.
    ...
    h2.mb-5 Pero… ¿Qué son los datos personales?
    ...
    .bg_grad-03.mb-5
      .row
        ...
        .col-12.col-lg-5.align-items-end
